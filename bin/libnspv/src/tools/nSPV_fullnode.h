...
{
    uint256 bhash;
    int32_t txidht, ntzht, nextht, i = 0;
...
int32_t NSPV_getntzsresp(struct NSPV_ntzsresp* ptr, int32_t origreqheight)
{
    ...
    int32_t reqheight = origreqheight;
...
{
    int32_t i;
    uint256 hashBlock, bhash0, bhash1, desttxid0, desttxid1;
    CTransaction tx;
...
{
    int32_t len, slen, ind, reqheight, n;
